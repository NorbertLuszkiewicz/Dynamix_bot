...
export const CHANGE_COMMAND_SWITCH_REQUEST = 'CHANGE_COMMAND_SWITCH_REQUEST';
export const CHANGE_COMMAND_SWITCH_SUCCESS = 'CHANGE_COMMAND_SWITCH_SUCCESS';
export const CHANGE_COMMAND_SWITCH_FAILURE = 'CHANGE_COMMAND_SWITCH_FAILURE';
